...
namespace ShimmerDataCollection
{
    ...
    public static class ShimmerConfig
    {
        ...
        /// </summary>
        public enum GSRRangeSetting
        {
            [UnityEngine.InspectorName("8-63kOhm resistance, 125 µS to 15.9 µS conductance")]
            zero = 0,
            [UnityEngine.InspectorName("63-220kOhm resistance, 15.9 µS to 4.0 µS conductance")]
            one = 1,
            [UnityEngine.InspectorName("220-680kOhm resistance, 4.0 µS to 1.5 µS conductance")]
            two = 2,
            [UnityEngine.InspectorName("680kOhm-4.7MOhm resistance, 1.5 µS to 0.2 µS conductance")]
            three = 3,
